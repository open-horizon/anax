...
require (
	...
	github.com/open-horizon/edge-sync-service v1.7.1
...
replace github.com/open-horizon/edge-sync-service => github.com/LiilyZhang/edge-sync-service v1.7.3-0.20220105171704-d283024090af
