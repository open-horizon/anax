...
func Test_FindForOutput0(t *testing.T) {
...
func Test_FindForOutput1(t *testing.T) {
	...
	_, err = persistence.SaveNewExchangeDevice(db, "testid", "testtoken", "testname", false, theOrg, "apattern")
	if err != nil {
