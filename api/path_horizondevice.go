...
// Given a demarshalled HorizonDevice object, validate it and return any errors.
func CreateHorizonDevice(device *HorizonDevice,
	...
	pDev, err := persistence.SaveNewExchangeDevice(db, *device.Id, *device.Token, *device.Name, haDevice, *device.Org, *device.Pattern)
	if err != nil {
