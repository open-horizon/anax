...
func (db *AgbotPostgresqlDB) DeleteHAUpgradeNodeByGroup(orgId string, groupName string) error {
	_, qerr := db.db.Exec(HA_GROUP_DELETE_NODE_BY_GROUP, groupName, orgId)
	return qerr
}
