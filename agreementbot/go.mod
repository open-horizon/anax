module github.com/open-horizon/anax/agreementbot

go 1.24.9

replace (
	github.com/open-horizon/anax => ..
...
require (
	...
	github.com/open-horizon/rsapss-tool v0.0.0-20190416131035-2fc75eb3b6ea // indirect
...
require (
	github.com/open-horizon/anax v0.0.0-20251104134858-4a5033123aeb
