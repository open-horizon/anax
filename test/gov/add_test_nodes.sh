...
do
	...
	curl -sLX POST --header 'Content-Type: application/json' --header 'Accept: application/json' -u "userdev/an12345${NUM}:Abcdefghijklmno1" -d '{"changeId":0,"maxRecords":1000,"orgList":["userdev"]}' "${EXCH_URL}/orgs/userdev/changes" > /dev/null
