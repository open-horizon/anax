...
api="policycompatible"
echo -e "\n${PREFIX} test /${api}. Input: node policy and business policy"
read -d '' comp_input <<EOF
{
...
echo -e "\n${PREFIX} test /${api}. Input: node policy, business policy and service policy"
read -d '' comp_input <<EOF
{
  "node_policy":      $node_policy,
  "business_policy":  $bp_location,
...
echo -e "\n${PREFIX} test /${api}. Input: node policy, business policy and service policy. not compatible"
...
echo -e "\n${PREFIX} test /${api}. Input: Mixed. node id, business policy. not compatible"
read -d '' comp_input <<EOF
{
  "node_id": "userdev/an12345",
  "business_policy": {
...
api=userinputcompatible
echo -e "\n${PREFIX} test /${api}. Input: node userinput, business policy. compatible"
read -d '' comp_input <<EOF
{
...
echo -e "\n${PREFIX} test /${api}. Input: node userinput, business policy. not compatible"
...
api=deploycompatible
echo -e "\n${PREFIX} test /${api}. Input: node policy, node userinput, business policy. compatible"
read -d '' comp_input <<EOF
{
  "node_policy":      $node_policy,
  "node_user_input":  $node_ui,
...
echo -e "\n${PREFIX} test /${api}. Input: node policy, node userinput, business policy. not compatible"
read -d '' comp_input <<EOF
{
  "node_policy":      $node_policy,
  "node_user_input":  $node_ui_bad,
...
echo -e "\n${PREFIX} test /${api}. Input: node policy, node userinput, business policy. Result: version 2.0.6 policy not compatible, version 2.0.7 user input not compatible."
...
echo -e "\n${PREFIX} test /${api}. Input: patten id, node user input. Result: compatible."
read -d '' comp_input <<EOF
{
  "node_user_input":  $node_ui,
...
echo -e "\n${PREFIX} test /${api}. Input: patten id, node user input. Result: not compatible."
read -d '' comp_input <<EOF
{
  "node_user_input":  $node_ui_bad,
  "pattern_id":       "e2edev@somecomp.com/sloc"
...
echo -e "\n${PREFIX} test /${api}. Input: node id, pattern id. Result: compatible."
read -d '' comp_input <<EOF
{
  "node_id":           "userdev/an12345",
  "pattern_id":       "e2edev@somecomp.com/sloc"
