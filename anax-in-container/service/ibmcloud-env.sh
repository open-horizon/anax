...
echo "Modifying $anaxJsonFile for IBM Cloud..."
...
if [[ -n "$HZN_EXCHANGE_URL" ]]; then
	...
	HZN_EXCHANGE_URL=https://stg-edge-cluster.us-south.containers.appdomain.cloud/v1/   #todo: for now this is staging, but must be changed eventually
fi
