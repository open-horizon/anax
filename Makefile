...
CSS_IMAGE_VERSION ?= 1.0.7$(BRANCH_NAME)
...
ESS_IMAGE_VERSION ?= 1.0.6$(BRANCH_NAME)
...
all: deps all-nodeps
all-nodeps: gopathlinks $(EXECUTABLE) $(CLI_EXECUTABLE) $(CSS_EXECUTABLE) $(ESS_EXECUTABLE) css-docker-image ess-docker-image
