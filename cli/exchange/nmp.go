...
func NMPNew() {
	...
	var nmp_template = []string{
		...
		`  "description": "",                         /* ` + msgPrinter.Sprintf("A much longer description of the policy.") + ` */`,
		...
		`  ],`,
		`  "properties": [                            /* ` + msgPrinter.Sprintf("A list of policy properties that describe this policy.") + ` */`,
		`    {`,
		`      "name": "",`,
		`      "value": null`,
		`    }`,
		`  ],`,
		`  "patterns": [                              /* ` + msgPrinter.Sprintf("This policy applies to nodes using one of these patterns.") + ` */`,
		`    ""`,
		`  ],`,
		...
		`  "agentUpgradePolicy": {                    /* ` + msgPrinter.Sprintf("Assertions on how the agent should update itself.") + ` */`,
