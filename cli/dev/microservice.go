...
func MicroserviceDeploy(homeDirectory string, keyFile string, userCreds string, dontTouchImage bool) {
	...
	microserviceDef.SignAndPublish(microserviceDef.Org, userCreds, keyFile, dontTouchImage)
