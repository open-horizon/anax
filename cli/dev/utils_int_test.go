...
func Test_nested_dependencies(t *testing.T) {
	...
	networks, perr := ProcessStartDependencies(horizonDir, deps, []common.GlobalSet{}, []policy.AbstractUserInput{}, cw, "12345", map[string]string{})
	if perr != nil {
...
func setupUT(t *testing.T, debug bool) (string, *container.ContainerWorker) {
	...
	projectDir, terr := os.TempDir("", "hzndev-util-test-")
	if terr != nil {
