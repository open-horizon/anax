...
func ManifestNew() {
	...
	var business_policy_template = []string{
		...
		`    "files": [               /* ` + msgPrinter.Sprintf("The name of a certificate file stored in the Management Hub. Default is \"agent-install.crt\".") + ` */`,
		`      "agent-install.crt"    /* ` + msgPrinter.Sprintf("Run 'hzn nm agentfiles list -t agent_cert_files' to get a list of available files.") + ` */`,
		`    ],`,
		`    "version": ""            /* ` + msgPrinter.Sprintf("The agent certificate version this manifest applies to. Specify \"latest\" to get the most recent version.") + ` */`,
		`  },`,
		...
		`    "files": [               /* ` + msgPrinter.Sprintf("The name of a config file stored in the Management Hub. Default is \"agent-install.crt\".") + ` */`,
