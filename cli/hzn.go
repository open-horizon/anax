...
`))
	...
	nmManifestRemoveType := nmManifestRemoveCmd.Flag("type", msgPrinter.Sprintf("The type of manifest to remove. Valid values include 'agent-upgrade-manifests'.")).Required().Short('t').String()
