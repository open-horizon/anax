...
`))
	...
	exUserCreateKeyUser := exUserCreateKeyCmd.Arg("username", msgPrinter.Sprintf("Username to create key for")).Required().String()
	...
	exUserGetKeyUser := exUserGetKeyCmd.Arg("username", msgPrinter.Sprintf("Username of the key owner")).Required().String()
	...
	exUserRemoveKeyUser := exUserRemoveKeyCmd.Arg("username", msgPrinter.Sprintf("Username of key owner")).Required().String()
