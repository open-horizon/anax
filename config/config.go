...
type Config struct {
	...
	CACertsPath                      string // Path to a dir containing PEM-encoded and DER-encoded x509 certs HTTP clients in Anax will trust (additive to the configuration option "TrustSystemCACerts")
	ExchangeURL                      string
